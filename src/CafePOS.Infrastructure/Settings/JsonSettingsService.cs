...
public sealed class JsonSettingsService : ISettingsService
{
 ...
 public JsonSettingsService(IDataPathProvider paths) { _paths=paths; try { Current=File.Exists(paths.SettingsPath)?JsonSerializer.Deserialize<AppSettings>(File.ReadAllText(paths.SettingsPath))??new():new(); } catch { Current=new(); } }
